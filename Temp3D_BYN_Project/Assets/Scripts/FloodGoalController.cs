...
public class FloodGoalController : MonoBehaviour
{
    ...
    // takes a scoreholder object, parses out the flood score, and displays it on the screen 
    public void updateScore(Scoreholder scoreholder)
    {
        float score = scoreholder.floodPts;
